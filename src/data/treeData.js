...
export const treeData = [
  {
    ...
    items: [
      { id: "w1", lines: ["1 layered", "06 wide wall"] },
      { id: "w2", lines: ["1 layered", "08 wide wall"]},
      { id: "w3", lines: ["1 layered", "10 wide wall"]},
      { id: "w4", lines: ["1 layered", "12 wide composite"] },
      { id: "w5", lines: ["1 layered", "25 wide composite"] },
      { id: "w6", lines: ["1 layered", "25 wide wall"]},
      { id: "w7", lines: ["1 layered", "30 wide wall"]},
      { id: "w8", lines: ["1 layered", "38 wide wall"], selected: true },
      { id: "w9", lines: ["Wall U Profile", "file"] },
    ],
  },
